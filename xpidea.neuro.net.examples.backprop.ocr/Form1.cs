...
namespace xpidea.neuro.net.examples.backprop.ocr
{
    ...
    public class Form1 : Form
    {
        ...
        public double[] CharToBitArray(char aChar, Font aFont, int aArrayDim, int aAddNoisePercent)
        {
        ...
        {
            backpropNetwork = new OCRNetwork(this, trackBar1.Value/100F, trackBar2.Value/100F,
        ...
        {
            label6.Text = "Learning rate: " + (trackBar1.Value/100F);
        }

        private void trackBar2_Scroll(object sender, EventArgs e)
        {
            label7.Text = "Momentum: " + (trackBar2.Value/100F);
        }
        ...
        public class OCRNetwork : BackPropagationNetwork
        {
            private readonly Form1 owner;

            public OCRNetwork(Form1 owner, double learningRate, double momentum, int[] nodesInEachLayer)
        ...
        private void InitializeComponent()
        {
            ...
            // trackBar2
            // 
            this.trackBar2.Location = new System.Drawing.Point(152, 120);
            ...
            // trackBar1
            // 
            this.trackBar1.Location = new System.Drawing.Point(152, 72);
            ...
            this.Name = "Form1";
            this.Text = "XPidea  -=Simple OCR Demo (BackProp network)=-";
